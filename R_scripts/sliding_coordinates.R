...
{
    outDir<-paste0("/bucket/MillerU/Abrar/hg38-", names(species2)[i], "_outputs/hg38-", names(species2)[i], "_sliding_coordinates_", window_size/1000, "kb/")
    ...
    {    
        ...
        writeLines(dt_text, paste0(outDir, chrom, "_", window_size/1000, "kb_min_window_sliding_coordinates.txt"))
        print("sliding coordinates calculated")
