...
species2<-list('rheMac10'=1,'papAnu4'=1,'macFas5'=1,'chlSab2'=1,'nasLar1'=1,'cerAty1'=1,'manLeu1'=1,'macNem1'=1,'colAng1'=1,'rhiBie1'=1,'rhiRox1'=1,'panPan3'=1,'panTro6'=1,'ponAbe3'=1,'nomLeu3'=1,'calJac4'=1,'saiBol1'=1,'tarSyr2'=1,'micMur3'=1,'galVar1'=1,'oryCun2'=1,'felCat9'=1,'equCab3'=1,'susScr11'=1,'oviAri4'=1,'triMan1'=1,'ornAna2'=1,'panPan3'=1,'panTro6'=1)
...
{
    outDir<-paste0("/bucket/MillerU/Abrar/hg38-", names(species2)[i], "_outputs/hg38-", names(species2)[i], "_tiled_pcs_", window_size/1000, "kb/")
    ...
    {    
        ...
        writeLines(dt_text, paste0(outDir, chrom, "_", window_size/1000, "kb_min_window_tiled_pcs.txt"))
