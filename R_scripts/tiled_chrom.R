...
window_size<-as.numeric(15000) 	##in bp
...
{
    outDir<-paste0("/bucket/MillerU/Abrar/hg38-", names(species2)[i], "_outputs/hg38-", names(species2)[i], "_tiled_chrom_", window_size/1000, "kb/")
    ...
    {    
        ...
        writeLines(dt_text, paste0(outDir, chrom, "_", window_size/1000, "kb_min_window_tiled_chrom.txt"))
        print("tiled chrom calculated")
    }
}#gc()