...
for(i in seq_along(species2))
{
    ...
    {    
        ...
        ## get_identical_seq_loc_hg38-calJac4   
        ## filtered_pcs_hg38-calJac4   
    ...
    for(window_size in window_list)
    {
          for(percent in percent_list)
          {
                ...
                {   
                    #outDir<-paste0("/bucket/MillerU/Abrar/hg38-calJac4_outputs/", window_size/1000, "kb/binned_quantile_kurtosis_genome_ave", "_", percent, "pc_500col/") #Gorilla
                    outDir<-paste0("/bucket/MillerU/Abrar/hg38-", names(species2)[i], "_outputs/", window_size/1000, "kb/binned_quantile_kurtosis_genome_ave", "_", percent, "pc/") #Others
