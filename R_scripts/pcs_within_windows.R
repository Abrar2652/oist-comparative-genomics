...
window_sizes<-list(as.numeric(10000000),as.numeric(5000000),as.numeric(2500000),as.numeric(1200000),as.numeric(500000),as.numeric(100000),as.numeric(50000))
##in [10000000, 5000000, 2500000, 1200000, 500000, 15000, 50000, 100000, 30000] bp

species1<-'hg38'			## UCSC stle abbreviation (hg38, calJac4, etc)	
species2<-list('mm39'=1)
