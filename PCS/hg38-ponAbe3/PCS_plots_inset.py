...
df = pd.read_csv("/bucket/.mabuya/MillerU/Abrar/PCS/hg38-ponAbe3/PCS_hg38ponAbe3.csv") 
df = df[df['Number of PCS of Length L']!=0][10:]
# Preparing the data for the plot
x = [i for i in df.index][1:]
y = df['Number of PCS of Length L'][1:]
x_fake = [i for i in df.index][1:790]
print(x_fake[0],x_fake[-1])
y_fake = df['Number of PCS of Length L'][1:790]#29:790
...
axIns = ax.inset_axes([0.06, 0.06, 0.47, 0.5])
...
ax.set_title('PCS length distribution of hg38/ponAbe3 genome alignment for L>=12', fontsize=15)
...
plt.savefig('/bucket/.mabuya/MillerU/Abrar/PCS/hg38-ponAbe3/hgpa3.png')
#ax.show()