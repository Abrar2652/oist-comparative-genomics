...
x_fake = [i for i in df.index][199:790]

print(x_fake[0], x_fake[-1])
y = df['Number of PCS of Length L'][:]
y_fake = df['Number of PCS of Length L'][199:790]
x=np.array(x)
...
y_fit = linear(x_fake, 5.7, 10**16.6)
...
ax.set_title('PCS length distribution of hg38/ponAbe3 genome alignment for L>=1', fontsize=15)
...
plt.savefig("/bucket/.mabuya/MillerU/Abrar/PCS/hg38-ponAbe3/hgpa_powerlaw.png")
#plt.show()
