...
cum_pcs_frame.to_csv(r'/bucket/MillerU/Abrar/PCS/Uppercase_analysis/cumulative_vanilla_pcs_for_each_IGS_whole_genome/cumulative_vanilla_pcs_in_vanilla_IGS_hg38{0}_largest{1}.csv'.format(genome,cutoff), index = False) 
...
plt.savefig('/bucket/MillerU/Abrar/PCS/Uppercase_analysis/cumulative_vanilla_pcs_for_each_IGS_whole_genome/cumulative_vanilla_pcs_in_vanilla_IGS_hg38{0}_largest{1}.png'.format(genome,cutoff))
