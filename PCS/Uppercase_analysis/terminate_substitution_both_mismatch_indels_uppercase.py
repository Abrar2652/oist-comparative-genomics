...
for genome in genome_list:
    ...
    #os.makedirs(path) 
    header_frame.to_csv(r'hg38_{1}_{0}_GT_AC_both_mismatch_indel_identical_seqs.tsv'.format(chrom, genome), sep="\t", index=False)
    ...
    df.to_csv(r'GT_AC_both_mismatch_indel_PCS_hg38{0}.csv'.format(genome), index = False) 
    '''
