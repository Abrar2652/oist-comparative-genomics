...
df = pd.read_csv("/bucket/.mabuya/MillerU/Abrar/PCS/hg38-panPan3/PCS_hg38panPan3.csv") 
...
ax.set_title('PCS length distribution of hg38/panPan3 genome alignment for L>=1', fontsize=15)
...
plt.savefig("/bucket/.mabuya/MillerU/Abrar/PCS/hg38-panPan3/hgpanpan3_powerlaw.png")
#plt.show()
