...
x_fake = [i for i in df.index][34:590]

print(x_fake[0], x_fake[-1])
y = df['Number of PCS of Length L'][:]
y_fake = df['Number of PCS of Length L'][34:590]
x=np.array(x)
...
y_fit = linear(x_fake, 4.3, 10**12.1)
...
ax.set_title('PCS length distribution of hg38/saiBol1 genome alignment for L>=1', fontsize=15)
...
plt.savefig("/bucket/.mabuya/MillerU/Abrar/PCS/hg38-saiBol1/hgsb1_powerlaw.png")
#plt.show()
