...
##### putting a very small value in P ######
...
rl_entro_df.to_csv("/bucket/MillerU/Abrar/PCS/hg38-{0}/relative_entropy/relative_entropy_down_{1}kb_win_hggg_ref_hggg_idea2.csv".format(genome,window_size), index=False)
