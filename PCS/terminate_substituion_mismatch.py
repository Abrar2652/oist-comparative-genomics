...
for genome in genome_list:
        ...
        for i in range(maxlen):
          #use a slice rather than index in case one string longer than other
            ...
            if (letter1==letter2 and letter1 in ['A','T','C','G','-'] and letter2 in ['A','T','C','G','-']):
                result1+=letter1
                result2+=letter2
            if ((letter1 == 'G' and letter2=='A') or (letter1 == 'A' and letter2=='G') or
                (letter1 == 'C' and letter2=='T') or (letter1 == 'T' and letter2=='C')): # substitution
                result1+=letter1
                result2+=letter2
    ...
    header_frame.to_csv(r'hg38_{1}_{0}_GA_CT_mismatch_terminated_seqs.tsv'.format(chrom, genome), sep="\t", index=False)
    ...
    df.to_csv(r'GA_CT_mismatch_terminated_PCS_hg38{0}.csv'.format(genome), index = False) 
