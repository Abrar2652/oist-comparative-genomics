...
x_fake = [i for i in df.index][129:765]

print(x_fake[0], x_fake[-1])
y = df['Number of PCS of Length L'][:]
y_fake = df['Number of PCS of Length L'][129:765]
x=np.array(x)
...
y_fit = linear(x_fake, 5.3, 10**15.4)
...
ax.set_title('PCS length distribution of hg38/nomLeu3 genome alignment for L>=1', fontsize=15)
...
plt.savefig("/bucket/.mabuya/MillerU/Abrar/PCS/hg38-nomLeu3/hgnl3_powerlaw.png")
#plt.show()
