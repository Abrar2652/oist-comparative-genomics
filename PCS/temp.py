...
import glob
import pandas as pd
genome_list = ['felCat9','equCab3','susScr11','oviAri4','triMan1','ornAna2','panPan3','panTro6',]
names = ['Cat','Horse','Pig','Sheep','Manatee','Platypus','Bonobo','Chimpanzee']
#genome_list = ['gorGor6']
#names = ['Gorilla']
