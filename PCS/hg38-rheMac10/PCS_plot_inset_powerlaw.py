...
x_fake = [i for i in df.index][79:720]

print(x_fake[0], x_fake[-1])
y = df['Number of PCS of Length L'][:]
y_fake = df['Number of PCS of Length L'][79:720]
x=np.array(x)
...
y_fit = linear(x_fake, 4.7, 10**13.55)
...
ax.set_title('PCS length distribution of hg38/rheMac10 genome alignment for L>=1', fontsize=15)
...
plt.savefig("/bucket/.mabuya/MillerU/Abrar/PCS/hg38-rheMac10/hgrm_powerlaw.png")
#plt.show()
