...
rl_entro_df.to_csv("/bucket/MillerU/Abrar/PCS/hg38-{0}/relative_entropy/relative_entropy_qdown_{1}kb_win_hggg_ref_hggg_idea3.csv".format(genome,window_size), index=False)
