...
ax.set_title('PCS length distribution of hg38/panTro6 genome alignment for L>=12', fontsize=15)
...
plt.savefig("/bucket/MillerU/Abrar/PCS/hg38-panTro6/hgpantro6.png")
#ax.show()