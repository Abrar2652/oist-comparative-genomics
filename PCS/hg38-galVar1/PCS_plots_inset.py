...
df = pd.read_csv("/bucket/.mabuya/MillerU/Abrar/PCS/hg38-galVar1/PCS_hg38galVar1.csv") 
df = df[df['Number of PCS of Length L']!=0]
# Preparing the data for the plot
x = [i for i in df.index][1:]
x_fake = [i for i in df.index][14:510]
#15:510 Lemur
#15:370 Mouse
print(x_fake[0], x_fake[-1])
y = df['Number of PCS of Length L'][1:]
y_fake = df['Number of PCS of Length L'][14:510]
x=np.array(x)
...
y_fit = linear(x_fake, 4, 10**10.9)
#10**10.3 mm6, mm10, galVar1
#10**10.9 micmur1
...
ax.set_title('PCS length distribution of hg38/galVar1 genome alignment for L>=1', fontsize=15)
ax.annotate("MSE: {:.3f}\nRMSE: {:.3f}\nR-squared: {:.3f}".format(MSE,RMSE,Rsquared),(2*10**2,10**4), fontsize=15, xytext=(200,1000))
...
plt.savefig("/bucket/.mabuya/MillerU/Abrar/PCS/hg38-galVar1/hggalVar1.png")
#plt.show()