...
df = pd.read_csv("/bucket/.mabuya/MillerU/Abrar/PCS/hg19-mm10/PCS_hg19mm10.csv") 
...
ax.set_title('PCS length distribution of hg19/mm10 genome alignment for L>=1', fontsize=15)
...
plt.savefig("/bucket/.mabuya/MillerU/Abrar/PCS/hg19-mm10//hgmm.png")
#plt.show()