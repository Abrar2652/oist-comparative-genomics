...
df = pd.read_csv("/bucket/.mabuya/MillerU/Abrar/PCS/hg38-gorGor6/PCS_hg38gorGor6.csv") 
...
ax.set_title('PCS length distribution of hg38/gorGor6 genome alignment for L>=7', fontsize=15)
ax.annotate("MSE: {:.3f}\nRMSE: {:.3f}\nR-squared: {:.3f}".format(MSE,RMSE,Rsquared),(1.2*10**1,10**4), fontsize=15, xytext = (12, 10**4))
...
plt.savefig("/bucket/MillerU/Abrar/PCS/hg38-gorGor6/hggg6.png")
#ax.show()