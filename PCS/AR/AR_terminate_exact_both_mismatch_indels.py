...
for genome in genome_list:
    ...
    header_frame.to_csv(r"AR_hg38_{1}_{0}_exact_both_mismatch_indel_identical_seqs.tsv".format(chrom, genome), sep="\t", index=False)
    ...
    df.to_csv(r"AR_exact_both_mismatch_indel_PCS_hg38{0}.csv".format(genome), index = False) 
