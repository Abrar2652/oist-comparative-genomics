...
for genome in genome_list:
        ...
        for i in range(maxlen):
          #use a slice rather than index in case one string longer than other
            ...
            if ((letter1 == letter2) and (letter1!='-') and (letter2!='-') and 
                ...
                result1+=letter1
                result2+=letter2
            if ((letter1 == 'g' and letter2=='t') or (letter1 == 't' and letter2=='g') or
                (letter1 == 'a' and letter2=='c') or (letter1 == 'c' and letter2=='a')): # substitution
                result1+=letter1
                result2+=letter2
            elif ((letter1 != letter2) or (letter1=='-') or (letter2=='-')):
                result1+='\n'
                result2+='\n'
    ...
    def matched_indices(df, column, j):
        ...
        for i,(letter1, letter2) in enumerate(zip(str1,str2)):#i=index, letter1=str1, letter2=str2
            if ((letter1 == letter2) and (letter1 in ['a','t','c','g']) and (letter2 in ['a','t','c','g'])) or ((letter1 == 'g' and letter2=='t') or (letter1 == 't' and letter2=='g') or (letter1 == 'a' and letter2=='c') or (letter1 == 'c' and letter2=='a')):  # substitution       
    ...
    header_frame.insert(loc=3, column = "first.sequence", value = seq1)
    ...
    header_frame.insert(loc=8, column = "second.sequence", value = seq2)
    ...
    #os.makedirs(path) 
    header_frame.to_csv(r'AR_hg38_{1}_{0}_gt_ac_both_mismatch_indel_identical_seqs.tsv'.format(chrom, genome), sep="\t", index=False)
    ...
    df.to_csv(r'AR_ga_ct_both_mismatch_indel_PCS_hg38{0}.csv'.format(genome), index = False) 
    '''
