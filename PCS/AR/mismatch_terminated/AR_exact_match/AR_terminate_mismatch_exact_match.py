...
for genome in genome_list:
    ...
    header_frame.to_csv(r'hg38_{1}_{0}_AR_mismatch_terminated_exact_match_seqs.tsv'.format(chrom, genome), sep="\t", index=False)
    ...
    df.to_csv(r'AR_mismatch_terminated_exact_match_PCS_hg38{0}.csv'.format(genome), index = False)
