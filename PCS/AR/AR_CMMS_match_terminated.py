...
for genome in genome_list:
    ...
    header_frame.to_csv(r'hg38_{1}_{0}_AR_CMMS_match_terminated_seqs.tsv'.format(chrom, genome), sep="\t", index=False)
    ...
    df.to_csv(r'AR_CMMS_match_terminated_PCS_hg38{0}.csv'.format(genome), index = False)
