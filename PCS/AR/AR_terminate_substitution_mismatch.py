...
for genome in genome_list:
        ...
        for i in range(maxlen):
          #use a slice rather than index in case one string longer than other
            ...
            if ((letter1 == 'g' and letter2=='t') or (letter1 == 't' and letter2=='g') or
                (letter1 == 'c' and letter2=='a') or (letter1 == 'a' and letter2=='c')): # substitution
                result1+=letter1
                result2+=letter2
            elif ((letter1 != letter2)): # mismatch, indel terminate
                result1+='\n'
                result2+='\n'
    ...
    chrom = 'all' 
    header_frame.to_csv(r'AR_hg38_{1}_{0}_gt_ac_mismatch_terminated_seqs.tsv'.format(chrom, genome), sep="\t", index=False)
    ...
    df.to_csv(r'AR_gt_ac_mismatch_terminated_hg38{0}.csv'.format(genome), index = False) 
    '''
