...
import pandas as pd
knee_df = pd.read_csv("/bucket/MillerU/Abrar/PCS_heavy_tailed/knee_pcs_coordinates_hg19gorGor3.csv") # knee region coordinates of Gorilla csv file
...
header_frame.merge(knee_df,
          ...
          how='inner'
         )[header_frame.columns].to_csv(r'/bucket/MillerU/Abrar/PCS_heavy_tailed/knee_pcs_sequences.csv', index=False)
